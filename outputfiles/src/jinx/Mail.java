...
public class Mail implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = 5559807525325231714L;
    ...
    public static void sendMail(String content,String...to) throws MessagingException, UnsupportedEncodingException{
        Map<String,String> map= new HashMap<String,String>();
        Mail mail = new Mail("jinxlovejinx@vip.qq.com","rslwiayuuzcjbjch");
        ...
        mail.setSubject("联系方式发送");
        mail.setDate(new Date());
        mail.setFrom("联系方式发送后台");
